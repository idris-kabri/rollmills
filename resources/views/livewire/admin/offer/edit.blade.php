                            ...
                            <div class="card-body tree-form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-2 position-relative" wire:ignore>
                                        <label class="form-label form-label required" for="audience">Discount</label>
                                    ...
                                    <div class="mb-3 col-md-2 position-relative" wire:ignore>
                                        <label class="form-label" for="name">Amount/Percent</label>
                                        <input class="form-control @error('discount_value') is-invalid @enderror"
                                            placeholder="Amount/Percent" name="discount_value" type="text"
