                ...
                <div class="col-md-12">
                    <div class="card shadow rounded-4 border-2">
                        <div class="card-header justify-content-between">
                            <h1 class="mb-0">Offer Detail</h1>
                            
                            {{--<button class="bg-success text-white d-flex align-items-center gap-1 btn rounded-3">Active</button>--}}
                        </div>

                        <div class="card-body py-4 px-4">
                            <div class="row mt-0">
                                <div class="col-lg-4 dashboard-widget-item">
                                    <div
                                        class="d-flex rounded-4 border-2 border position-relative overflow-hidden text-decoration-none bg-light order-return-card">
                                        <div
                                            class="d-flex justify-content-between w-100 align-items-center details px-4 py-3">
                                            <div class="desc fw-medium">Total Usage</div>
                                            <div class="number fw-bolder">
                                                <p class="m-0 text-secondary">{{ $total_user_count }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 dashboard-widget-item">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="number fw-bolder">
                                                <p class="m-0 text-secondary">{{ $total_order_amount }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 dashboard-widget-item">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="number fw-bolder">
                                                <p class="m-0 text-secondary">{{ $total_discount_amount }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="px-3 py-4">
                                            ...
                                            <p class="mb-2 text-dark fs-15">
                                                ...
                                                <a class="order-return-hover"
                                                    href="{{ route('admin.customer.customer-detail', $order->getUser->id) }}">{{ $order->getUser->name }}
                                                </a>
                                            </p>
                                            <p class="mb-2 text-dark fs-15">
                                                <strong class="text-secondary">Email &nbsp; :
                                                    &nbsp;</strong>
                                                <a class="order-return-hover"
                                                    href="{{ route('admin.customer.customer-detail', $order->getUser->id) }}">
                                                    {{ $order->getUser->email }}
                                                </a>
                                            </p>
                                            <p class="mb-2 text-dark fs-15">
                                                <strong class="text-secondary">Discount &nbsp; :
                                                    &nbsp;</strong>
