                    ...
                    <div class="page-pretitle">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <h1 class="mb-0 d-inline-block fs-6 lh-1">Create Banner</h1>
                                </li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <div class="card-body tree-form-body">
                            <form enctype="multipart/form-data" wire:submit.prevent="store">
                                ...
                                <div class="mb-3 position-relative">
                                    ...
                                    <select class="form-control form-select @error('banner_type') is-invalid @enderror"
                                        wire:model.live="banner_type" name="banner_type" required>
                                ...
                                @if($banner_type == 'slider_banner')
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <input class="form-control @error('heading') is-invalid @enderror"
                                            placeholder="Heading" name="heading" type="text" wire:model="heading">
                                        @error('heading')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3 position-relative" wire:ignore>
                                        ...
                                        <textarea name="sub_heading" class="form-control editor-ckeditor @error('sub_heading') is-invalid @enderror"
                                            rows="4" placeholder="Write Sub Heading" name="sub_heading" id="sub_heading" cols="50" wire:model="sub_heading"></textarea>
                                        @error('sub_heading')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 position-relative">
                                    ...
                                    <select name="audience" class="form-control select2 @error('banner_type') is-invalid @enderror"
                                ...
                                <div class="mb-3 position-relative">
                                    ...
                                    <div class="image-box image-box-image" action="select-image" data-counter="250">
                                        ...
                                        <input type="file" id="imageInput" name="image" wire:model="image" accept="image/*"
                                            style="display: none;" />
                                        </br>
                                        @if($banner_type == 'slider_banner')
                                ...
                                <div class="mb-3 position-relative">
                                    <label class="form-check form-switch d-inline-block">
                                        ...
                                        <input class="form-check-input" wire:model.live="is_default" type="checkbox"
