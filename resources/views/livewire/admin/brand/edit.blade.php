<div class="page-wrapper">
    ...
    <div>
        <div class="page-body page-content">
            <div class="container-xl">
                <form method="POST" wire:submit.prevent="update" class="js-base-form dirty-check">
                    @csrf
                    <div class="row">
...
<script>
    function selectImage() {
        $("#file-input").click();
        document.getElementById("preview-image-main").style.display = "none";
        document.getElementById("preview-image-temporary").style.display = "none";
    };
</script>
<script type="module">
    import {
