                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="form-body">
                                    ...
                                    <div class="mb-3 position-relative" wire:ignore>
                                        <label class="form-label required" for="main_description">
                                            Description
                                        </label>

                                        <textarea
                                            class="form-control editor-ckeditor ays-ignore @error('main_description') is-invalid @enderror"
                                            data-counter="100000" rows="4" placeholder="Description" id="main_description" wire:model='main_description'
                                    ...
                                    <div class="mb-3 position-relative" wire:ignore>
                                        ...
                                        <textarea class="form-control editor-ckeditor ays-ignore @error('short_description') is-invalid @enderror"
                                            data-counter="100000" rows="4" placeholder="Write your content" id="short_description"
                                            wire:model='short_description' name="short_description" cols="50"></textarea>
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <input class="form-control @error('youtube_link') is-invalid @enderror"
                                            data-counter="250" name="youtube_link"
                                            placeholder="Please Enter Youtube Video Link" wire:model='youtube_link'
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <div class="gallery-images-wrapper list-images form-fieldset">
                                            <div class="images-wrapper mb-2">
                                                ...
                                                <input type="file" name="new_images" id="gallery-input"
                                                    style="display: none;" accept="image/*" wire:model="new_images"
                                                    multiple>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div class="row price-group">
                                            ...
                                            <div class="mb-3 position-relative">
                                                ...
                                                <div class="input-group input-group-flat">
                                                    ...
                                                    <input name="price"
                                                        ...
                                                        type="number" wire:model='price' id="price" />
                                                    @error('price')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3 position-relative">
                                                <label class="form-label" for="sale_default_price">
                                                    Sale Default Price
                                                </label>

                                                <div class="input-group input-group-flat">
                                                    <span class="input-group-text">₹</span>
                                                    <input name="sale_default_price"
                                                        class="form-control input-mask-number @error('sale_default_price') is-invalid @enderror"
                                                        type="text" wire:model='sale_default_price'
                                                        id="sale_default_price" />
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3 position-relative">
                                                ...
                                                <div class="input-group input-group-flat">
                                                    ...
                                                    <input name="discount"
                                                        class="form-control input-mask-number @error('discount') is-invalid @enderror"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <label
                                                    ...
                                                    <input type="checkbox" name="is_bulk_inquiry_supported"
                                                        wire:model='is_bulk_inquiry_supported'
                                                        class="form-check-input" id="stockCheck">
                                    ...
                                    <fieldset class="form-fieldset">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-md-6" wire:ignore>
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <div class="input-group input-group-flat">
                                                        ...
                                                        <input name="weight"
                                                            ...
                                                            type="text" wire:model='weight' id="weight" />
                                                        @error('weight')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <div class="input-group input-group-flat">
                                                        <textarea name="pincode_excluded" class="form-control @error('pincode_excluded') is-invalid @enderror"
                                                            wire:model='pincode_excluded' id="pincode_excluded" rows="3"></textarea>
                                                ...
                                                <div
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        <select name="selectedAttribute"
                                                            class="form-select @error('selectedAttribute') is-invalid @enderror"
                                ...
                                <div class="card-body">
                                    <div class="add-new-product-attribute-wrap">
                                        ...
                                        <div class="accordion" id="">
                                            ...
                                            $name .=
                                            $selectedOptions[$value_array[0]]['items'][
                                            $value_array[1]
                                            ] . ' ';
                                            }
                                            }
                                            ...
                                            <div class="accordion-item mb-3">
                                                <div
                                                    ...
                                                    <a class="text-danger mx-2" href="javascript:void(0);"
                                                        wire:click.prevent="removeVariation('{{ $key }}')">
                                                        Remove
                                                    </a>
                                                </div>
                                                    ...
                                                    <div class="accordion-body">
                                                                        ...
                                                                        <div style="width: 8rem"
                                                                            ...
                                                                            <div class="preview-image-inner">
                                                                                <a data-bb-toggle="image-picker-choose"
                                                                                    ...
                                                                                    $selectedVariationOption[$key]['details']['image'] != null &&
                                                                                    $selectedVariationOption[$key]['details']['image'] != '')
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        name="selectedVariationOption[{{ $key }}][details][sku]"
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <label class="form-check form-switch d-inline-block ">
                                                                    ...
                                                                    <input name="is_active" class="form-check-input" wire:model="selectedVariationOption.{{ $key }}.details.is_active" type="checkbox"
                                                                        value="1" id="selectedVariationOption.{{ $key }}.details.is_active" />
                                                                ...
                                                                <div class="images-wrapper mb-2">
                                                                    <div data-bb-toggle="gallery-add"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            @if (count($selectedVariationOption[$key]['details']['gallery_images']) > 0)
                                                                            @foreach ($selectedVariationOption[$key]['details']['gallery_images'] as $key1 => $image)
                                                                            <div
                                                                                class="col-md-2 col-4 mb-3 me-2 position-relative">
                                                                                <img src="{{ $image->temporaryUrl() }}"
                                                                                    alt="Product Image"
                                                                                    style="width: 100px; height: 100px" />
                                                                                <button type="button"
                                                                                    class="btn btn-danger btn-sm position-absolute top-0 end-0 remove-temp-image"
                                                                                    wire:click="removeGallaryImage('{{ $key }}', {{ $key1 }}, 'variations')">
                                                                                    ×
                                                                                </button>
                                                                            </div>
                                                                            @endforeach
                                                                    ...
                                                                    <input type="file"
                                                                        ...
                                                                        wire:model="tempImages.{{ $key }}"
                                                                        multiple>

                                                                    @error('tempImages.{{ $key }}')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                                    @enderror
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="exampleInputEmail1"
                                                                        class="form-label ">Sales Default
                                                                        Price</label>
                                                                    <input type="text"
                                                                ...
                                                                <div class="mb-3">
                                                                    <div
                                                                        ...
                                                                        <div class="d-flex justify-content-end">
                                                                            <a class="variations-turn-on-schedule"
                                                                    ...
                                                                    <input type="text"
                                                                        name="selectedVariationOption[{{ $key }}][details][sale_price]"
                                                            ...
                                                            <div class="col-md-6"
                                                                ...
                                                                <div class="mb-3 position-relative">
                                                                    ...
                                                                    <input
                                                                        name="selectedVariationOption[{{ $key }}][details][from_date]"
                                                            ...
                                                            <div class="col-md-6"
                                                                ...
                                                                <div class="mb-3 position-relative">
                                                                    ...
                                                                    <input
                                                                        name="selectedVariationOption[{{ $key }}][details][sale_date]"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-3 position-relative" wire:ignore>
                                                                ...
                                                                <textarea name="selectedVariationOption[{{ $key }}][details][description]"
                                    ...
                                    <div class="seo-edit-section" v-pre>
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input class="form-control @error('seo_title') is-invalid @enderror"
                                                data-counter="70" placeholder="SEO Title" name="seo_title"
                                                data-allow-over-limit type="text" id="seo_meta[seo_title]"
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input class="form-control @error('seo_meta') is-invalid @enderror"
                                                data-counter="70" name="seo_meta" placeholder="SEO Meta"
                                                data-allow-over-limit wire:model="seo_meta" type="text"
                                                id="seo_meta">
                                            @error('seo_meta')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                        ...
                                        <div class="mb-3 position-relative" wire:ignore>
                                            ...
                                            <textarea class="form-control editor-ckeditor @error('seo_description') is-invalid @enderror" id="seo_description"
                                                data-counter="160" rows="3" placeholder="SEO description" data-allow-over-limit id="seo_description"
                                                wire:model="seo_description" name="seo_description" cols="2"></textarea>
                    ...
                    <div class="col-md-3 gap-3 d-flex flex-column-reverse flex-md-column mb-md-0 mb-5">
                        ...
                        <div class="card meta-boxes">
                            ...
                            <div class=" card-body">
                                <select class="form-control form-select @error('status') is-invalid @enderror"
                                    required="required" id="status-select-10813" name="status" wire:model="status">
                        ...
                        <div class="card meta-boxes">
                            ...
                            <div class=" card-body">
                                <label class="form-check form-switch d-inline-block ">
                                    <input wire:model="is_featured" name="is_featured" type="hidden"
                                        value="0" />
                                    <input class="form-check-input" name="is_featured" wire:model="is_featured"
                            ...
                            <div class=" card-body">
                                <div class="mb-3">
                                    <div class="input-icon">
                                        <input type="text" name="categoriesSearch"
                                            id="search-category-input-1676138032" class="form-control"
                                            placeholder="Search..." wire:model.live="categoriesSearch" />
                        ...
                        <div class="card meta-boxes" wire:ignore>
                            ...
                            <div class="card-body">
                                <select name="brand_id"
                                    ...
                                    data-placeholder="Select a brand..." data-allow-clear="true" id="brand_select"
                                    multiple>
                                    @foreach ($brands as $brand)
                                    <option value="{{ $brand->id }}"
                                        {{ in_array($brand->id, $brand_id ?? []) ? 'selected' : '' }}>
                                        {{ $brand->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="card meta-boxes" wire:ignore>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="related_products">Select Related Product</label>
                                    <select name="related_products"
                                        class="select-search-full form-select select2 @error('related_products') is-invalid @enderror"
                                        data-placeholder="Select a Related Product..." data-allow-clear="true"
                                        id="related_products_select" multiple wire:model="related_products"
                                        onchange="select2Function('related_products')">
                                        @foreach ($all_products as $related_product)
                                        <option value="{{ $related_product->id }}">{{ $related_product->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    <label for="linked_products">Select Linked Product</label>
                                    <select name="linked_products"
                                        class="select-search-full form-select select2 @error('linked_products') is-invalid @enderror"
                                        data-placeholder="Select a Linked Product..." data-allow-clear="true"
                                        id="linked_products_select" multiple wire:model="linked_products"
                                        onchange="select2Function('linked_products')">
                                        @foreach ($all_products as $linked_product)
                                        <option value="{{ $linked_product->id }}">{{ $linked_product->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class=" card-body">
                                <div class="image-box image-box-image" action="select-image" data-counter="250">
                                    ...
                                    <input type="file" name="featured_image" id="featured-image-input"
                                        style="display: none;" accept="image/*" wire:model="featured_image">
...
<script type="module">
    ...
    document.addEventListener('livewire:load', function() {
        Livewire.on('reset-file-input', (data) => {
