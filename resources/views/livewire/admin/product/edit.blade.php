            ...
            <form method="POST" wire:submit.prevent="formSubmit" enctype="multipart/form-data">
                ...
                <div class="row" wire:key="main-content-row" wire:ignore.self>
                                ...
                                <div class="form-body">
                                    <div class="mb-3 position-relative" wire:ignore>
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror"
                                            data-counter="250" placeholder="Name" name="name" required="required"
                                            wire:model.live='name' type="text" id="name">
                                        @error('name')
                                    ...
                                    <div class="mb-3 position-relative" wire:ignore>
                                        ...
                                        <textarea class="form-control form-control editor-ckeditor ays-ignore @error('main_description') is-invalid @enderror"
                                            data-counter="100000" rows="4" placeholder="Short main_description" id="main_description"
                                            wire:model='main_description' cols="50" name="main_description"></textarea>
                                    ...
                                    <div class="mb-3 position-relative" wire:ignore>
                                        ...
                                        <textarea class="form-control editor-ckeditor ays-ignore @error('short_description') is-invalid @enderror"
                                            data-counter="100000" name="short_description" rows="4" placeholder="Write your content"
                                            id="short_description" wire:model='short_description' cols="50"></textarea>
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <div class="gallery-images-wrapper list-images form-fieldset">
                                            <div class="images-wrapper mb-2">
                                                        ...
                                                        <div class="row">
                                                            @foreach ($default_gallery_images as $key => $image)
                                                                <div class="col-md-2 col-4 mb-3 position-relative">
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        wire:click="removeGallaryImage('existing', {{ $key }})">
                                                                        ×
                                                                    </button>
                                                                </div>
                                                            @endforeach
                                                            ...
                                                            @foreach ($gallery_images as $key => $image)
                                                                <div class="col-md-2 col-4 mb-3 position-relative">
                                                                    ...
                                                                    <button type="button"
                                                                        class="btn btn-danger btn-sm position-absolute top-0 end-0 remove-temp-image"
                                                                        wire:click="removeGallaryImage('new', {{ $key }})">
                                                                        ×
                                                                    </button>
                                                                </div>
                                                            @endforeach
                                                ...
                                                <input name="images[]" type="file" name="gallery_images"
                                                    id="gallery-input" style="display: none;" accept="image/*"
                                            ...
                                            <div class="mb-3 position-relative">
                                                ...
                                                <div class="input-group input-group-flat">
                                                    ...
                                                    <input
                                                        ...
                                                        name="price" type="number" wire:model='price'
                                                        id="price" />
                                                    @error('price')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                            ...
                                            <div class="mb-3 position-relative">
                                                ...
                                                <div class="input-group input-group-flat">
                                                    ...
                                                    <input
                                                        ...
                                                        type="text" name="sale_default_price"
                                                        wire:model='sale_default_price' id="default_sale_price" />
                                            ...
                                            <div class="mb-3 position-relative">
                                                ...
                                                <div class="input-group input-group-flat">
                                                    ...
                                                    <input
                                                        ...
                                                        name="discount" type="text" wire:model='discount'
                                                        id="sale_price" />
                                            ...
                                            <div class="col-6">
                                                ...
                                                <label
                                                    ...
                                                    <input type="checkbox" wire:model='is_bulk_inquiry_supported'
                                                        class="form-check-input" name="is_bulk_inquiry_supported"
                                                        {{ $is_bulk_inquiry_supported == 1 ? 'checked' : '' }}
                                                        id="stockCheck">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <div class="input-group input-group-flat">
                                                        ...
                                                        <input
                                                            ...
                                                            type="text" wire:model='weight' name="weight"
                                                            id="weight" />
                                                        @error('weight')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                            ...
                                            <div class="col-md-3 col-md-6">
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <div class="input-group input-group-flat">
                                                        <input name="gst"
                                                            class="form-control input-mask-number @error('gst') is-invalid @enderror"
                                                            type="number" wire:model='gst'
                                                            id="gst" />
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <div class="input-group input-group-flat">
                                                        <textarea class="form-control @error('pincode_excluded') is-invalid @enderror" name="pincode_excluded"
                                                ...
                                                <div
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        <select
                                                            ...
                                                            name="selectedAttribute" wire:model="selectedAttribute"
                                                            id="global-option">
                                                        ...
                                                        <div class="accordion-body">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class=" card-body">
                                                                        <div class="image-box image-box-image"
                                                                            ...
                                                                            <p class="text-danger mb-0">1100 x 1100px
                                                                            </p>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <label
                                                                        ...
                                                                        <input wire:model="is_active" name="is_active"
                                                                            type="hidden" />
                                                                        <input name="is_active"
                                                                            class="form-check-input"
                                                                            wire:model="selectedVariationOption.{{ $key }}.details.is_active"
                                                                            type="checkbox" value="1"
                                                                            {{ isset($selectedVariationOption[$key]['details']['is_active']) && $selectedVariationOption[$key]['details']['is_active'] == 1 ? 'checked' : '' }}
                                                                            id="selectedVariationOption.{{ $key }}.details.is_active" />
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="images-wrapper mb-2">
                                                                        <div data-bb-toggle="gallery-add"
                                                                            ...
                                                                            <div class="">
                                                                                <div class="row">
                                                                                    @if (count($selectedVariationOption[$key]['details']['existing_gallery_images']) > 0 ||
                                                                                            count($selectedVariationOption[$key]['details']['gallery_images']) > 0)
                                                                                        ...
                                                                                        @foreach ($selectedVariationOption[$key]['details']['gallery_images'] as $key1 => $image)
                                                                                            <div
                                                                                                class="col-md-2 col-4 mb-3 position-relative">
                                                                                                <div
                                                                        ...
                                                                        <input type="file"
                                                                            ...
                                                                            wire:model="selectedVariationOption.{{ $key }}.details.gallery_images"
                                                                            multiple
                                                                            name="selectedVariationOption[{{ $key }}][details][gallery_images]">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="mb-3">
                                                                        <label for="exampleInputEmail1"
                                                                            class="form-label @error('name') is-invalid @enderror">Shipping
                                                                            Bear Margin Charges</label>
                                                                        <input type="number"
                                                                            name="selectedVariationOption[{{ $key }}][details][weight]"
                                    ...
                                    <div class="seo-edit-section" v-pre>
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input class="form-control @error('seo_title') is-invalid @enderror"
                                                ...
                                                type="text" id="seo_meta[seo_title]" name="seo_title"
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input name="seo_meta"
                                                class="form-control @error('seo_meta') is-invalid @enderror"
                                        ...
                                        <div class="mb-3 position-relative" wire:ignore>
                                            ...
                                            <textarea name="seo_description" class="form-control editor-ckeditor @error('seo_description') is-invalid @enderror"
                                                id="seo_description" data-counter="160" rows="3" placeholder="SEO description" data-allow-over-limit
                                                id="seo_description" wire:model="seo_description" cols="2"></textarea>
                    ...
                    <div class="col-md-3 gap-3 d-flex flex-column-reverse flex-md-column mb-md-0 mb-5"
                        wire:key="second-content" wire:ignore>
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">
                                    Publish
                            ...
                            <div class=" card-body">
                                <label class="form-check form-switch d-inline-block ">
                                    <input wire:model="is_featured" name="is_featured" type="hidden"
                                        value="0" />
                                    <input name="is_featured" class="form-check-input" wire:model="is_featured"
                                        type="checkbox" value="1" {{ $is_featured == 1 ? 'checked' : '' }}
                                        id="is_featured" />
                                    @error('is_featured')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                        ...
                        <div class="card meta-boxes">
                            ...
                            <div class=" card-body">
                                <label class="form-check form-switch d-inline-block ">
                                    ...
                                    <input name="is_active" class="form-check-input" wire:model="is_active"
                                        type="checkbox" value="1" {{ $is_active == 1 ? 'checked' : '' }}
                                        id="is_active" />
                                    @error('is_active')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group" wire:ignore>
                                    ...
                                    <select
                                        ...
                                        name="related_products" id="related_products_select" multiple>
                                ...
                                <div class="form-group" wire:ignore>
                                    ...
                                    <select
                                        ...
                                        name="linked_products" id="linked_products_select" multiple>
                            ...
                            <div class=" card-body">
                                <div class="image-box image-box-image" action="select-image" data-counter="250">
                                            ...
                                            <a data-bb-toggle="image-picker-choose" data-target="popup"
                                                ...
                                                @if (!$featured_image && $defaultFeaturedImage)
                                                    <img src="{{ Storage::url($defaultFeaturedImage) }}"
                                                        alt="Product Image" class="rounded mx-auto d-block"
                                    ...
                                    <input type="file" id="featured-image-input" style="display: none;"
                                        accept="image/*" name="featured_image           "
