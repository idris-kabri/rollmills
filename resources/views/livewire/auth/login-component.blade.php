                                    ...
                                    <form method="post" wire:submit.prevent="loginCheck">
                                        <div class="form-group mb-20">
                                            <label for="" class="ps-2 fw-600 quicksand fs-16 mb-2"> Enter Mobile
                                                Number</label>
                                            <input type="number" required wire:model.live="mobile"
                                                placeholder="Enter 10-digit Number" class="login-input"
                                        ...
                                        @if ($otp_section_show)
                                            <div class="form-group mb-20" x-data="{
                                                next(i, e) {
                                                        // keep only one digit
                                                ...
                                                <div class="d-flex justify-content-between"
                                                    x-on:paste.prevent="paste($event)">
                                                    <input type="text" id="otp1" x-ref="o0"
                                                        class="otp-input login-input text-center" style="width: 24%"
                                                        maxlength="1" inputmode="numeric" pattern="[0-9]*"
                                                        autocomplete="one-time-code" wire:model.live="otp.0"
                                                    ...
                                                    <input type="text" id="otp2" x-ref="o1"
                                                        class="otp-input login-input text-center" style="width: 24%"
                                                        maxlength="1" inputmode="numeric" pattern="[0-9]*"
                                                        wire:model.live="otp.1" x-on:input="next(1, $event)"
                                                        x-on:keydown.backspace="prev(1, $event)">

                                                    <input type="text" id="otp3" x-ref="o2"
                                                        class="otp-input login-input text-center" style="width: 24%"
                                                        maxlength="1" inputmode="numeric" pattern="[0-9]*"
                                                        wire:model.live="otp.2" x-on:input="next(2, $event)"
                                                        x-on:keydown.backspace="prev(2, $event)">

                                                    <input type="text" id="otp4" x-ref="o3"
                                                        class="otp-input login-input text-center" style="width: 24%"
                                                        maxlength="1" inputmode="numeric" pattern="[0-9]*"
                                                        wire:model.live="otp.3" x-on:input="next(3, $event)"
