<main class="main">
    <section class="hero-3 position-relative align-items">
        ...
        <ul class="list-inline nav nav-tabs links font-xs text-center">
            ...
            <li class="list-inline-item nav-item"><a class="nav-link font-xs" href="shop-grid-right.html">Coffes</a>
            </li>
            <li class="list-inline-item nav-item"><a class="nav-link font-xs" href="shop-grid-right.html">Pet Foods</a>
            </li>
            <li class="list-inline-item nav-item"><a class="nav-link font-xs" href="shop-grid-right.html">Vegetables</a>
            </li>
        </ul>
    </section>
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="shop-product-right.html">
                                    ...
                                    <img class="hover-img" src="a{{asset('assets/frontend/imgs/shop/product-1-2.jpg')}}" alt="" />
                                </a>
                            </div>
