<main class="main home-page-main">
    ...
    <section class="product-tabs section-padding position-relative pt-md-4 pt-0">
        <div class="container" wire:ignore.self>
            ...
            <div class="row product-grid-4">
                @php
                    $category_product_category_assign = \App\Models\ProductCategoryAssign::where('category_id', $popular_category->id)->pluck('product_id');
                    $category_popular_products = \App\Models\Product::where('status', 1)->where('is_featured', 1)->whereIn('id', $category_product_category_assign)->inRandomOrder()->limit(10)->get();
                @endphp
