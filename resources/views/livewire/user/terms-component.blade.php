                     ...
                     <div class="row">
                         <div class="col-lg-9">
                             <div class="single-page pr-30 mb-lg-5 mb-sm-5">
                                 <h1 class="title style-3 mb-20" style="background-position: left bottom;">Terms and
                                     Conditions</h1>
                                 ...
                                 <ul>
                                     <li>
                                         <p><strong>Affiliate</strong> means an entity that controls, is controlled by,
                                     ...
                                     <li>
                                         <p><strong>Device</strong> means any device that can access the Service such as
                                             a computer, a cell phone or a digital tablet.</p>
                                     </li>
                                     <li>
                                 ...
                                 <h4 class="mb-2 mt-40">Acknowledgment</h4>
                                 <p>These are the Terms and Conditions governing the use of this Service and the
                                     ...
                                     out the rights and obligations of all users regarding the use of the Service.</p>
                                 ...
                                 <h4 class="mb-2 mt-40">Links to Other Websites</h4>
                                 ...
                                 <h4 class="mb-2 mt-40">Termination</h4>
                                 ...
                                 <h4 class="mb-2 mt-40">Limitation of Liability</h4>
                                 ...
                                 <p>To the maximum extent permitted by applicable law, in no event shall the Company or
                                     ...
                                     loss of privacy arising out of or in any way related to the use of or inability to
                                 ...
                                 <h4 class="mb-2 mt-40">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h4>
                                 <p>The Service is provided to You &quot;AS IS&quot; and &quot;AS AVAILABLE&quot; and
                                     ...
                                     fitness for a particular purpose, title and non-infringement, and warranties that
                                 ...
                                 <p>Without limiting the foregoing, neither the Company nor any of the company's
                                     ...
                                     as to the operation or availability of the Service, or the information, content,
                                     and materials or products included thereon; (ii) that the Service will be
                                     uninterrupted or error-free; (iii) as to the accuracy, reliability, or currency of
                                     any information or content provided through the Service; or (iv) that the Service,
                                     its servers, the content, or e-mails sent from or on behalf of the Company are free
                                 ...
                                 <h4 class="mb-2 mt-40">Governing Law</h4>
                                 ...
                                 <h4 class="mb-2 mt-40">Disputes Resolution</h4>
                                 ...
                                 <h4 class="mb-2 mt-40">For European Union (EU) Users</h4>
                                 <p>If You are a European Union consumer, you will benefit from any mandatory provisions
                                     of the law of the country in which You are resident.</p>
                                 <h4 class="mb-2 mt-40">United States Legal Compliance</h4>
                                 <p>You represent and warrant that (i) You are not located in a country that is subject
                                     ...
                                     parties.</p>
                                 <h4 class="mb-2 mt-40">Severability</h4>
