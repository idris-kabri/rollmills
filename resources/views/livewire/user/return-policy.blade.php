         ...
         <div class="container">
             <div class="row">
                 <div class="col-xl-10 col-lg-12 m-auto">
                     <div class="row">
                         <div class="col-lg-9">
                             <div class="single-page pr-30 mb-lg-5 mb-sm-5">
                                 <h1 class="title style-3 mb-20" style="background-position: left bottom;">Return Policy
                                 </h1>
                                 <p>Last updated: November 05, 2025</p>
                                 <p>Thank you for shopping at Roll Mills.</p>
                                 <p>The following terms are applicable for any products that You purchased with Us.</p>
                                 <h4 class="mb-2 mt-40">Interpretation</h4>
                                 <p>The words whose initial letters are capitalized have meanings defined under the
                                 ...
                                 <h4 class="mb-2 mt-40">Definitions</h4>
                                 <p>For the purposes of this Return and Refund Policy:</p>
                                 <ul>
                                     <li>
                                         <p><strong>Company</strong> (referred to as either &quot;the Company&quot;,
                                             &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers
                                             to Roll Mills, 205 North Michigan Avenue, Suite 810 Chicago, 60601, USA
                                             Phone: (123) 456-7890 Email: contact@Evara.com.</p>
                                     </li>
                                     <li>
                                         <p><strong>Goods</strong> refer to the items offered for sale on the Service.
                                         </p>
                                     </li>
                                     <li>
                                     ...
                                     <li>
                                         <p><strong>Website</strong> refers to Roll Mills, accessible from <a
                                                 href="http://www.rollmills.com" rel="external nofollow noopener"
                                                 target="_blank">http://www.rollmills.com</a></p>
                                     </li>
                                     <li>
                                 ...
                                 <h4 class="mb-2 mt-40">Your Order Cancellation Rights</h4>
                                 <p>You are entitled to cancel Your Order within 7 days without giving any reason for
                                     doing so.</p>
                                 <p>The deadline for cancelling an Order is 7 days from the date on which You received
                                     the Goods or on which a third party you have appointed, who is not the carrier,
                                     takes possession of the product delivered.</p>
                                 <p>In order to exercise Your right of cancellation, You must inform Us of your decision
                                 ...
                                 <ul>
                                     ...
                                     <li>
                                         <p>By visiting this page on our website: <a
                                                 href="http://www.rollmills.com/contact"
                                 ...
                                 <p>We will reimburse You no later than 14 days from the day on which We receive the
                                     ...
                                     and You will not incur any fees for such reimbursement.</p>
                                 <h4 class="mb-2 mt-40">Conditions for Returns</h4>
                                 ...
                                 <ul>
                                     ...
                                     <li>The supply of Goods which are not suitable for return due to health protection
                                         or hygiene reasons and were unsealed after delivery.</li>
                                     <li>The supply of Goods which are, after delivery, according to their nature,
                                         inseparably mixed with other items.</li>
                                 </ul>
                                 <p>We reserve the right to refuse returns of any merchandise that does not meet the
                                     above return conditions in our sole discretion.</p>
                                 <p>Only regular priced Goods may be refunded. Unfortunately, Goods on sale cannot be
                                     refunded. This exclusion may not apply to You if it is not permitted by applicable
                                     law.</p>
                                 <h4 class="mb-2 mt-40">Returning Goods</h4>
                                 <p>You are responsible for the cost and risk of returning the Goods to Us. You should
                                     send the Goods at the following address:</p>
                                 <p>The Delivery Boy will pick it up</p>
                                 <p>We cannot be held responsible for Goods damaged or lost in return shipment.
                                     Therefore, We recommend an insured and trackable mail service. We are unable to
                                     issue a refund without actual receipt of the Goods or proof of received return
                                     delivery.</p>
                                 <h4 class="mb-2 mt-40">Gifts</h4>
                                 <p>If the Goods were marked as a gift when purchased and then shipped directly to you,
                                     You'll receive a gift credit for the value of your return. Once the returned
                                     product is received, a gift certificate will be mailed to You.</p>
                                 <p>If the Goods weren't marked as a gift when purchased, or the gift giver had the
                         ...
                         <div class="col-lg-3 primary-sidebar sticky-sidebar">
                             <div class="widget-area">
                                 ...
                                 <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
                                     ...
                                     <div class="single-post clearfix">
                                         <div class="image">
                                             <img src="{{ asset('assets/frontend/imgs/shop/thumbnail-6.jpg') }}"
                                                 alt="#" />
                                         </div>
                                         <div class="content pt-10">
                                 ...
                                 <div class="banner-img wow fadeIn mb-40 animated d-lg-block d-none">
                                     <img src="{{ asset('assets/frontend/imgs/banner/banner-11.png') }}"
                                         alt="" />
