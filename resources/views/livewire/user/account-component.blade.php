                             ...
                             <div class="my-account-cards">
                                 <a href="#"
                                     ...
                                     <div class="content">
                                         ...
                                         <p class="fw-500 text-secondary">Track, return, or buy things again</p>
                                     </div>
                                 </a>
                             </div>
                         </div>
                         <div class="col-lg-4 col-md-6 col-12 mb-30">
                             <div class="my-account-cards">
                                 <a href="#"
                                     class="card px-4 d-flex flex-row py-4 rounded-15 shadow-sm text-center border border-2">
                                     <div class="img-section me-4">
                                         <img src="{{ asset('assets/frontend/imgs/icon&images/mission.png') }}"
                                             alt="" class="img-fluid mx-auto">
                                     </div>
                                     <div class="content">
                                         <h5 class="underline text-start mb-2">Login & Security</h5>
                                         <p class="fw-500 text-secondary">Edit login, name, and mobile number</p>
                                     </div>
                                 </a>
                             </div>
                         </div>
                             ...
                             <div class="my-account-cards">
                                 <a href="#"
                                     ...
                                     <div class="content">
                                         ...
                                         <p class="fw-500 text-secondary">Edit addresses for orders and gifts</p>
                                     </div>
                                 </a>
                             </div>
                         </div>
