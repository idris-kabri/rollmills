                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="terms-list text-muted small text-start mt-3 mx-auto">
                                            ...
                                            @endif
                                            <li>You can use these coupon code after
                                                <strong>{{ \Carbon\Carbon::parse($coupon->start_date)->format('d M Y') }}</strong>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="order-card-mobile">
                                        <div class="order-card-header">
                                            <div>
                                                ...
                                                <div class="fs-12 text-muted">
                                                    {{ $user_order->created_at->format('d M, Y') }}</div>
                                            </div>
                                            <div>
                                                @if ($user_order->is_coupon_avail == 0)
                                                    <span
                                                        class="badge bg-danger-light text-danger rounded-pill px-2">Pending
                                                        Claim</span>
                                                @else
                                                    <span
                                                        class="badge bg-success-light text-success rounded-pill px-2">Claimed</span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="order-card-footer">
                                            <div>
                                                ...
                                                <span
                                                    class="text-brand fs-18 fw-800">₹{{ number_format($user_order->total) }}</span>
                                            </div>
