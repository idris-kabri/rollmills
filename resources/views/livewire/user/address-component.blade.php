         ...
         <div class="container">
             <div class="row">
                 <div class="col-xl-10 col-lg-10 m-auto">
                             ...
                             <div class="col-lg-4 py-2 mb-4">
                                 <div class="card address-cards border-2 p-4 rounded-15">
                                     ...
                                     <div class="d-flex align-items-center">
                                         <a href="#" wire:click.prevent="editAddress({{ $address->id }})"
                                             ...
                                             <i
                                                 class="fi fi-rs-edit me-1 d-flex justify-content-center align-items-center"></i>Edit</a>
                                         <a href="#" wire:click.prevent="deleteAddress({{ $address->id }})"
                     ...
                     @if ($show_addres)
                         <form method="post" wire:submit.prevent="saveAddress">
                             @csrf
                             <div class="row mt-20 pt-lg-5">
                                 <div class="content mb-20">
                                     @if ($address_id != null)
                                         <h1 class="title style-3 mb-20 text-center">Edit Address</h1>
                                     @else
                                 ...
                                 <div class="col-md-6 col-lg-4">
                                     <div class="form-group mb-25">
                                         ...
                                         <input type="text" placeholder="Enter Your Name" required
                                             class="login-input2" wire:model="name" />
                                     </div>
                                 </div>
                                 <div class="col-md-6 col-lg-4">
                                     <div class="form-group mb-25">
                                         ...
                                         <input type="email" placeholder="Enter Your Name" required
                                             class="login-input2" wire:model="email" />
                                     </div>
                                 </div>
                                 <div class="col-md-6 col-lg-4">
                                     <div class="form-group mb-25">
                                         ...
                                         <input type="text" placeholder="Enter Your Number" required
                                             class="login-input2" wire:model="mobile" />
                                     </div>
                                 </div>
                                 <div class="col-md-6 col-lg-4">
                                     <div class="form-group mb-25">
                                 ...
                                 <div class="col-md-6 col-lg-4">
                                     <div class="form-group mb-25">
                                         ...
                                         <input type="text" placeholder="Enter Your Locality / Town"
                                             class="login-input2" wire:model="city" />
                                     </div>
                                 </div>
                                 <div class="col-md-6 col-lg-4">
                                     <div class="form-group mb-25">
                                         ...
                                         <input type="text" placeholder="Enter Your Pincode" required
                                             class="login-input2" wire:model="zipcode" />
                                     </div>
                                 </div>
                                 <div class="col-md-6">
                                     <div class="form-group mb-25">
                                         <label for=""
                                             ...
                                             1</label>
                                         <textarea class="login-input2" placeholder="Enter You Adrress 1" id="floatingTextarea1" style="min-height: 150px"
                                             required wire:model="address_line_1"></textarea>
                                     </div>
                                 </div>
                                 <div class="col-md-6">
                                     <div class="form-group mb-25">
                                         <label for=""
                                             class="ps-1 text-secondary fw-700 quicksand fs-16 mb-1">Address
                                             2</label>
                                         <textarea class="login-input2" placeholder="Enter You Adrress 2" id="floatingTextarea2" style="min-height: 150px"
                                             wire:model="address_line_2"></textarea>
                                     </div>
                                 </div>
                             </div>
                             <div class="form-group mt-3 d-flex justify-content-center">
                                 @if ($address_id != null)
                                     <button type="submit"
                                         ...
                                         name="login">Edit Address</button>
                                 @else
                                     <button type="submit"
                                         class="btn quicksand fw-600 btn-block fs-18 pt-10 pb-10  hover-up hover-brand"
