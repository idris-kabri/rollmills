         ...
         <div class="product-img-action-wrap">
             <div class="product-img product-img-zoom">
                 ...
                 <a href="{{ $shop_detail_url }}">
                     ...
                     @endphp
                     <img class="hover-img" src="{{ asset('storage/' . $product_images[0]) }}"
                         alt="{{ $product->seo_meta }}" />
                 </a>
             </div>
             ...
             <div class="product-card-bottom">
                 ...
                 @if ($get_sold == false)
                     ...
                     @else
                         ...
                         @if (!$itemInCart)
                             <div class="add-cart" wire:loading.remove wire:target="addToCart">
                                 <a href="#" wire:click.prevent="addToCart({{ $product->id }})"
                                     class="add"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                             </div>
                         ...
                         @else
                             <a href="{{ route('cart') }}" class="btn-view-cart" style="white-space: nowrap;">
