        ...
        <div class="col-lg-6 p-4 bg-white right-box">
          ...
          <div id="stepMobile">
            ...
            <div class="input-group mb-3">
              ...
              <input type="tel" id="mobileInput" class="form-control" placeholder="Enter mobile number" maxlength="10">
            </div>
            ...
            <button class="btn btn-login w-100 mb-3" id="sendOtpBtn">Send OTP</button>
