                                    ...
                                    <div class="row mx-0">
                                        @foreach ($products as $query)
                                            <div
                                                ...
                                                <div
                                                    class="row mx-md-2 gx-md-2 gx-1 justify-content-center align-items-center">
                                                    <div class="col-xl-2 col-3">
                                                        <div class="product-img">
                                                            <a href="">
                                                                <img src="{{ '/storage/' . $query->featured_image }}"
                                                                    alt="{{ '/storage/' . $query->featured_image }}"
                                                                    loading="lazy">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-10 col-9">
                                                        <div class="product_info">
                                                            <div class="product_title"><a
                                                                    href="{{ route('shop-product-detail', $query->id) }}">{{ $query->name }}</a>
                                                            </div>
                                                            <div class="product_price">
                                                                ...
                                                                <span
                                                                    class="price">₹{{ number_format($priceInfo['price']) }}</span>
