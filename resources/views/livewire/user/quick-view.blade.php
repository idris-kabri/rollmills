<div class="modal fade custom-modal" id="quickViewModal" tabindex="-1" aria-labelledby="quickViewModalLabel"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" wire:click="$dispatch('closeQuickView')"></button>
                ...
                <div class="row">
                        ...
                        <div class="detail-gallery">
                            ...
                            <div class="thumbnail-gallery d-flex gap-2 flex-wrap">
                                ...
                                <a class="thumbnail-item {{ $main_image == $mainProduct->featured_image || !$main_image ? 'active-thumb' : '' }}"
                                    wire:click="changeMainImage('{{ $mainProduct->featured_image }}')" wire:mouseover="changeMainImage('{{ $mainProduct->featured_image }}')">
                                ...
                                <a class="thumbnail-item {{ $main_image == $image ? 'active-thumb' : '' }}"
                                    wire:click="changeMainImage('{{ $image }}')" wire:mouseover="changeMainImage('{{ $image }}')">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                            ...
                            $currentDate = now();
                            $sale_from_date = $mainProduct->sale_start_date ? \Carbon\Carbon::parse($mainProduct->sale_start_date) : null;
                            $sale_to_date = $mainProduct->sale_end_date ? \Carbon\Carbon::parse($mainProduct->sale_end_date) : null;

                            if ($mainProduct->sale_price > 0 && $sale_from_date && $sale_to_date && $currentDate->between($sale_from_date, $sale_to_date)) {
                            ...
                            <h3 class="title-detail"><a href="shop-product-right.html" class="text-heading">{{$mainProduct->name }}</a></h3>
                            <div class="product-detail-rating">
                                <div class="product-rate-cover text-end">
                                    <div class="product-rate d-inline-block">
                                        <div class="product-rating" style="width: {{$mainProduct_reviews_percentage}}%"></div>
                                    </div>
                                    <span class="font-small ml-5 text-muted"> ({{$mainProduct_reviews_count}} reviews)</span>
                                </div>
                            </div>
                            <div class="clearfix product-price-cover">
                                <div class="product-price primary-color float-left">
                                    ...
                                    $currentDate <= $mainProduct->sale_end_date) {
                                        ...
                                        if ($sale_price) {
                                        $discount_percentage = $original_price > 0
                            ...
                            <div class="attr-detail attr-size mb-30" wire:ignore>
                                ...
                                <ul class="list-filter size-filter font-small">
                                    ...
                                    <li class="{{ $selectedAttribute[$key] == $item ? 'active-ietm' : '' }} mb-2" style="border: 1px solid #dca915; border-radius: 5px;">
                            ...
                            <div class="detail-extralink mb-30">
                                ...
                                <div class="product-extra-link2">
                                    <button type="submit" class="button button-add-to-cart" wire:click="addToCart()"><i
