                ...
                <div class="row mb-50 mt-30">
                    ...
                    <div class="col-md-7 col-lg-6 col-sm-12 col-xs-12">
                        ...
                        <div class="detail-info">
                            ...
                            {{-- WRAPPER FOR RESPONSIVE REORDERING --}}
                            <div class="d-flex flex-column">

                                {{-- Short Description: 2nd on Mobile (order-2), 1st on Desktop (order-md-1) --}}
                                <div class="order-2 order-md-1 short-desc mb-30 mt-md-20 mt-10">
                                    ...
                                    @foreach ($groupedAttributes as $key => $attributes)
                                        <div class="" wire:key="attr-group-{{ $key }}">
                                            <div class="mb-2 d-flex align-items-center">
                                                ...
                                                <span
                                                    class="var-label-value">{{ $selectedAttribute[$key] ?? '' }}</span>
                                            </div>
