...
class FakeReviewScript extends Command
{
    ...
    private function generateEnglishReview($rating)
    {
        if ($rating == 5) {
            ...
            $closings = [
                "Overall a good deal. Giving 4 stars for the quick delivery.",
                "Recommended if you are on a budget. Good job.",
                "Worth buying during the sale. Happy with it.",
                "Good service and support. Would recommend it.",
                "Nice product. Hope it lasts long.",
                "Satisfactory experience. A solid 4-star product.",
                "Removing one star just for the packaging. Otherwise great.",
                "Good buy for beginners. You can go for it.",
                "Will update the review after using it for a month.",
                "If you can ignore minor flaws, this is a great product.",
                "Decent purchase. No regrets.",
                "A reliable choice. Good for the price.",
                "Can be improved slightly, but overall I am happy.",
                "Good value for money. Thanks to the seller.",
                "Would have given 5 stars if delivery was faster.",
                "Nice addition to my home. looks good.",
                "Overall satisfied. Will try other products from this brand.",
                "A balanced product with good features."
            ];
        }
